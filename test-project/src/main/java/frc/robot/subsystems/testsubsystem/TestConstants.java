...
public class TestConstants {
  ...
  public static final TalonFXConfiguration CW_CONFIG = new TalonFXConfiguration()
    ...
    .withSlot0(MotorConfigUtils.createSlotConfig(KP, KD, KS, KV, 0, GravityTypeValue.Elevator_Static));
}
